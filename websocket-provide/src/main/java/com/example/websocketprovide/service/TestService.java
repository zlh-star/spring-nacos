package com.example.websocketprovide.service;
...
//    }
    ...
    public void test1(String destination, HelloMessage helloMessage) {
//        Thread.sleep(1000); // simulated delay
//        String name=Objects.requireNonNull(accessor.getUser()).getName();
        String a= helloMessage.getMessage()+"/"+helloMessage.getName();
        simpMessagingTemplate.convertAndSend(destination,a);
    }
}
